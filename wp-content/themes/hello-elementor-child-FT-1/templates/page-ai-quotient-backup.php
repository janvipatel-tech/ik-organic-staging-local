   ...
   <section class="hero">
        <div class="container hero-container p-md-0">
            <div class="hero-content">
                <h1 class="hero-title">Is Your Resume <span class="text-primary">AI-Ready</span>? <span class="hero-title-span">Find Out in Just a Minute.</span></h1>
                ...
                <div class="upload-card">
                    ...
                    <div class="upload-area" id="uploadArea">
                        <p>+ Choose file <span>(.pdf only, max file size 3MB)</span></p>
                    </div>
            ...
            <div class="hero-image">
                ...
                <img src="<?php echo esc_url($heroimage); ?>" alt="Resume Analyzer Dashboard" loading="lazy" decoding="async">
            </div>
        </div>
    </section>
